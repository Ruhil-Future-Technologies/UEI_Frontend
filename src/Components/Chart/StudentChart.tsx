    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (userdata?.entity_name === 'college') {
          ...
          Object.entries(performanceData[0]).forEach(
            ([subjectId, data]: [string, any]) => {
              if (subjectMap[subjectId]) {
                labels.push(subjectMap[subjectId]);
            ...
            const activeDays = Object.values(study_data?.usage).map(
              (month: any) =>
                Object.values(month)
                  ...
                  .reduce(
                    (sum: number, week: any) => sum + week.total_days_active,
                    0,
                  ),
            );
          ...
          options: {
            ...
            yaxis: [
              ...
              },
              {
                ...
                min: 0,
                max:
                  activeTab === 'daily' ? 7 : activeTab === 'weekly' ? 7 : 30,
                labels: {
