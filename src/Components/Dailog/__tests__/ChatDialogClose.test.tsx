...
describe("ChatDialogClose", () => {
  ...
  it("should render the dialog when open", () => {
    ...
    expect(screen.getByText("Are you sure you want to Close this.")).toBeInTheDocument();
  ...
  it("should not render the dialog when closed", () => {
    ...
    expect(screen.queryByText("Are you sure you want to Close this.")).not.toBeInTheDocument();
  });
