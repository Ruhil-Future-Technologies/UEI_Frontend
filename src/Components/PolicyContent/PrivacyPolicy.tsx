            ...
            <div className="col-12">
              <div id="list-item-1" className="mb-5">
                ...
                <p className="mb-5">
                  ...
                  collected by Gyansetu, operated by Ruhil Future Technologies,
                  through its platform, website, and associated services.
                </p>

                <h6 className="fw-bold">Personal Information</h6>
                <p className="mb-5">
                  Gyansetu is committed to safeguarding user privacy. We collect
                  and use personal data responsibly to enhance the learning
                  experience while ensuring transparency and control over your
                  information. Unless otherwise authorized, Gyansetu will only
                  collect and use personal information as outlined below.
                </p>
                ...
                <ul>
                  <li>
                    When you register on the Gyansetu Platform (website, mobile
                    app, or integrated services).
                  </li>
                  <li>
                  ...
                  <li>
                    When schools, parents, or teachers provide necessary student
                    details to customize educational services.
                  </li>
                  <li>
              ...
              <div id="list-item-2">
                <h6 className="fw-bold mb-2">Types of Information Collected</h6>
                <p>Gyansetu may collect the following types of information:</p>
                <ul>
                  <li>
                    <strong> Personal Details </strong> : Name, Address, Email,
                    Phone Number, Age, School Details.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    (for premium features) and billing details where applicable.
                  </li>
                </ul>
                ...
                <ul>
                  ...
                  <li>
                    Track student progress and provide performance insights for
              ...
              <div id="list-item-4">
                ...
                <ul>
                  <li>
                    Like many digital platforms, Gyansetu collects Log Data and
                    Cookies for performance monitoring and usability
                    improvements.
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    Regular Audits: Security policies are reviewed periodically
                    for compliance.
                  </li>
                </ul>
                <p>
