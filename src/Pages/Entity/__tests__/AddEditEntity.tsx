...
const mockLocation = { pathname: '/main/Entity', search: '', hash: '', state: null };
...
describe('AddEditEntity Component', () => {
  ...
  it('validates entity_type input correctly', async () => {
    ...
    await waitFor(() => {
        ...
        expect(getByText((content, _element) => {
          return /Please enter a valid Entity type; whitespace is not allowed./i.test(content);
        })).toBeInTheDocument();
      });
