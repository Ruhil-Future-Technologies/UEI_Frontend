...
const InstituteRegistrationForm = () => {
    ...
    const validation = (name: string, value: string) => {
        setError({
            institute_name_error: name === "institute_name" && !/^[a-zA-Z]+(\s[a-zA-Z]+)*$/.test((value).trim()) ? true : false,
            university_id_error: false,
            institute_type_error: false,
            school_name_error: false,
            email_id_error: name === "email_id" && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test((value).trim()) ? true : false,
            mobile_no_error: name === "mobile_no" && !/^\d{10}$/.test((value).trim()) ? true : false,
            website_error: name === "website" && (value).trim() === '' ? true : false,
            country_error: false,
            state_error: false,
            city_error: name === "city" && !/^[a-zA-Z]+(\s[a-zA-Z]+)*$/.test((value).trim()) ? true : false,
            district_error: name === "district" && !/^[a-zA-Z]+(\s[a-zA-Z]+)*$/.test((value).trim()) ? true : false,
            address_error: name === "address" && !/^[a-zA-Z]+(\s[a-zA-Z]+)*$/.test((value).trim()) ? true : false,
    ...
    const handleSubmit = () => {
        setError({
            institute_name_error: selectedEntity === "College" && (valueInstitute.institute_name === "") ? true : false,
            university_id_error: selectedEntity === "College" && (valueInstitute.university_id.trim() === "") ? true : false,
            institute_type_error: (valueInstitute.entity_id).trim() === '' ? true : false,
            email_id_error: !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test((valueInstitute.email_id).trim()) ? true : false,
            mobile_no_error: !/^\d{10}$/.test((valueInstitute.mobile_no).trim()) ? true : false,
            ...
            school_name_error: selectedEntity === "School" && !(valueInstitute.school_name === "") ? true : false,
            city_error: !/^[a-zA-Z]+(\s[a-zA-Z]+)*$/.test((valueInstitute.city).trim()) ? true : false,
            district_error: !/^[a-zA-Z]+(\s[a-zA-Z]+)*$/.test((valueInstitute.district).trim()) ? true : false,
            address_error: !/^[a-zA-Z]+(\s[a-zA-Z]+)*$/.test((valueInstitute.address).trim()) ? true : false,
            pincode_error: !/^\d{6}$/.test((valueInstitute.pincode).trim()) ? true : false,
            document_error: valueInstitute.document === null ? true : false,
        })

        if (
                !error.institute_name_error && selectedEntity === "College" ? !(valueInstitute.institute_name === "") : true &&
                !error.university_id_error && selectedEntity === "College" ? !(valueInstitute.university_id === "") : true &&
                !error.school_name_error && selectedEntity === "School" ? !(valueInstitute.school_name === "") : true &&
                !error.institute_type_error && !(valueInstitute.entity_id === "") &&
                !error.email_id_error && !(valueInstitute.email_id === "") &&
                !error.mobile_no_error && !(valueInstitute.mobile_no === "") &&
                !error.website_error && !(valueInstitute.website === "") &&
                !error.country_error && !(valueInstitute.country === "") &&
                !error.state_error && !(valueInstitute.state === "") &&
                !error.city_error && !(valueInstitute.city === "") &&
                !error.district_error && !(valueInstitute.district === "") &&
                !error.address_error && !(valueInstitute.address === "") &&
                !error.pincode_error && !(valueInstitute.pincode === "") &&
                !error.document_error && valueInstitute.document
        ) {
            ...
            <div className="access1-card" >
                <div className="card-body">
                        ...
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <div>
                                {error.website_error === true && (
                                    <p className="error-text " style={{ color: 'red' }}>Valid Website is required.</p>
                                )}
                            </div>
                        </div>
                    </div>
                    {(selectedEntity === "School") ?
                        <div className="row d-flex justify-content-center">
                            ...
                            <div className="col-12">
                                ...
                                <div>
                                    {error.website_error === true && (
                                        <p className="error-text " style={{ color: 'red' }}>Valid School Name is required.</p>
                                    )}
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col-md-6 col-12 mb-3">
                                ...
                                <div>
                                    {error.university_id_error === true && (
                                        <p className="error-text " style={{ color: 'red' }}>Valid University Name is required.</p>
                                    )}
                                </div>
                            </div>
                            <div className="col-md-6 col-12 mb-3">
                                ...
                                <div>
                                    {error.institute_name_error === true && (
                                        <p className="error-text " style={{ color: 'red' }}>Valid Institute Name is required.</p>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <div>
                                {error.mobile_no_error === true && (
                                    <p className="error-text " style={{ color: 'red' }}>Valid Mobile number is required.</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <div>
                                {error.email_id_error === true && (
                                    <p className="error-text " style={{ color: 'red' }}>Valid Email Id is required.</p>
                                )}
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <div>
                                {error.city_error === true && (
                                    <p className="error-text " style={{ color: 'red' }}>Valid City is required.</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <div>
                                {error.district_error === true && (
                                    <p className="error-text " style={{ color: 'red' }}>Valid District is required.</p>
                                )}
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <div>
                                {error.address_error === true && (
                                    <p className="error-text " style={{ color: 'red' }}>Valid Address is required.</p>
                                )}
                            </div>
                        </div>
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <div>
                                {error.pincode_error === true && (
                                    <p className="error-text " style={{ color: 'red' }}>Valid Pincode is required.</p>
                                )}
                            </div>
                    ...
                    <div className=" d-flex justify-content-center m-2">
                        <Button variant="contained" disabled={CheckTermandcondi} onClick={handleSubmit}>Submit Form</Button>
                    </div>
