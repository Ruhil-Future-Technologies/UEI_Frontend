                            ...
                            <div className="card-body">
                                <div className="d-flex align-items-start justify-content-between mb-3">
                                    ...
                                    <div className="d-flex align-items-center gap-1 text-dark fw-semibold">
                                        to <span className="text-primary d-inline-flex align-items-center gap-1">(2.5%)<ArrowUpwardOutlinedIcon /></span>
                                    </div>
                                ...
                                <div className="table-responsive">
                                    ...
                                    <table className="table fs-14 align-middle mntable">
                                        ...
                                        {Teachers.map((teacher, index) => (
                                            <tr key={index}>
                                                <td><img src={teacher.image} alt="" /></td>
                                                <td>{teacher.name}</td>
                        ...
                        <div className="card w-100 rounded-4">
                            <div className="card-body">
                                <div className="d-flex align-items-start justify-content-between mb-3">
                                    ...
                                    <div className="d-flex align-items-center gap-1 text-dark fw-semibold">
                                        {totelStudents} <span className="text-primary d-inline-flex align-items-center gap-1">(2.5%)<ArrowUpwardOutlinedIcon /></span>
                                    </div>
