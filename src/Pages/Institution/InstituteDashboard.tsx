                                ...
                                <div className="card-body">
                                    <div className="d-flex align-items-start justify-content-between mb-3">
                                        ...
                                        <div className="d-flex align-items-center gap-1 text-dark fw-semibold">
                                            70 <span className="text-primary d-inline-flex align-items-center gap-1">(2.5%)<ArrowUpwardOutlinedIcon /></span>
                                        </div>
                            ...
                            <div className="card w-100 rounded-4">
                                <div className="card-body">
                                    <div className="d-flex align-items-start justify-content-between mb-3">
                                        ...
                                        <div className="d-flex align-items-center gap-1 text-dark fw-semibold">
                                            300 <span className="text-primary d-inline-flex align-items-center gap-1">(2.5%)<ArrowUpwardOutlinedIcon/></span>
                                        </div>
