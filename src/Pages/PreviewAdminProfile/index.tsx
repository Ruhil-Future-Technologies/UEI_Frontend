...
const PreviewAdminProfile: React.FC<PreviewAdminProfileProps> = ({
  editProfile,
  handleStep,
  isEdit1,
  isEditfun,
                          ...
                          <div className="card-body text-center profilebody">
                            ...
                            >
                              <div
                                className="progress-bar custom-progress-bar"
                                role="progressbar"
                                style={{ width: `${desctiptionPercentage}%` }}
                                aria-valuenow={desctiptionPercentage}
                                aria-valuemin={0}
                                aria-valuemax={100}
                              ></div>
                            </div>
                            ...
                            >
                              <div
                                className="progress-bar custom-progress-bar"
                                role="progressbar"
                                style={{ width: `${professionPercentage}%` }}
                                aria-valuenow={professionPercentage}
                                aria-valuemin={0}
                                aria-valuemax={100}
                              ></div>
                            </div>
