...
function StudentBasicInfo() {
  ...
  const submitHandel = (event: React.FormEvent<HTMLFormElement>) => {
          ...
          if(data.status == 200)
            {
              ...
              setNamepro({ 
                ...
                last_name: basicInfo?.last_name,
                gender: basicInfo?.gender,})
                getData(`${"upload_file/get_image/"}${selectedFile ? selectedFile : basicInfo?.pic_path}`)
                .then((data: any) => {
    ...
    const editData = async () => {
      putData(`${"student/edit/"}${StudentId}`, payload).then((data:any) => {
      ...
      <div className="row d-flex mt-5">
        <div className="col-md-6 pb-3 form_field_wrapper">
          ...
          />
           <div> {fname_col && (
                    ...
                    <div> {(basicInfo?.first_name == "" && fname_col1) && (
        ...
        <div className="col-md-6 pb-3 form_field_wrapper">
          ...
          />
           <div> {lname_col && (
                    ...
                    <div> {(basicInfo?.last_name == "" && lname_col1) &&  (
        ...
        <div className="col-md-6 pb-3 form_field_wrapper">
          ...
          />
           <div> {fathername_col && (
                    ...
                    <div> {(basicInfo?.father_name == "" && fathername_col1) &&(
        ...
        <div className="col-md-6 pb-3 form_field_wrapper">
          ...
          <div> {mothername_col && (
                    ...
                    <div> {(basicInfo?.mother_name == "" &&mothername_col1) && (
