...
describe('SuperAdmin Component', () => {
    ...
    it('validates email input correctly', async () => {
        ...
        await waitFor(() => {
            expect(getByText(/Please enter a valid email or phone number/i)).toBeInTheDocument();
        });
    });
    ...
    it('submits form with valid data', async () => {
        ...
        await waitFor(() => {
            ...
            const useridField = screen.getByLabelText(/Email or Mobile Number \*/i) as HTMLInputElement;
