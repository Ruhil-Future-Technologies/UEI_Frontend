    ...
    return (
        <main className="main-wrapper">
            <div className="main-content">
                ...
                <div className="d-lg-none mb-4 ms-auto d-flex"><button onClick={toggleRecent}
                            className="btn btn-outline-secondary ms-auto btn-sm d-flex align-items-center justify-content-center"><CloseOutlinedIcon/></button>
                                </div>
                        ...
                        <ul className="history-list">
                            <li>
                                ...
                                <li role="button"><DeleteOutlinedIcon/></li>
                                <li role="button"><BookmarkOutlinedIcon/></li>
                                </ul>
                            </li>
                    ...
                    <div className="main-chat-panel">
                        <div className="mobile-chat-header d-lg-none">
                            <ul>
                                <li onClick={toggleRecent}><SyncAltOutlinedIcon/></li>
                            </ul>
                        </div>
                        <div className="inner-panel">
                            <div className="chat-header2">

                                <button className="btn btn-primary btn-sm d-flex align-items-center gap-1 rounded-pill"><AddOutlinedIcon/>New Chat</button>
                                <button className="btn d-flex align-items-center justify-content-center px-0"><OutlinedFlagOutlinedIcon/></button>
                            </div>
                            <div className="chat-result">
                                <ul>
                                    <li className="left-chat">
                                        ...
                                        <div className="chat-card">
                                            <div className="chat-card-header">
                                                <span className="anstext"><DescriptionOutlinedIcon/> Answer</span>
                                            </div>
                                            ...
                                            <ul className="ansfooter">
                                                <li><ThumbUpAltOutlinedIcon/></li>
                                                <li><ThumbDownAltOutlinedIcon/></li>
                                                <li><ContentCopyOutlinedIcon/> <span>Copy</span> </li>
                                                <li><VolumeUpOutlinedIcon/> <span>Read</span></li>
                                                <li><LoopOutlinedIcon/> <span>Regenerate</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li className="right-chat">
                                        ...
                                        <div className="chat-card">
                                            <div className="chat-card-header">
                                                <span className="anstext"><SearchOutlinedIcon/> Question</span>
                                            </div>
                                            <div className="chat-card-body">
                                                <p>Certainly! Here&apos;s a brief description of each of the famous Renaissance
                                                    painters listed:</p>
                            ...
                            <div className="chat-suggestion">
                                <h4>Suggestions</h4>
                                <ul className="slider">
                                    <li><ChatOutlinedIcon/> Start my history exam</li>
                                    <li><ChatOutlinedIcon/> What&apos;s the news today</li>
                                    <li><ChatOutlinedIcon/> Test myself</li>
                                </ul>
                                <div className="dots"></div>
                            </div>
                            <div className="chat-input">
                                <input type="text" className="form-control" placeholder="Type your question" />
                                <button className="btn btn-primary"><ArrowUpwardOutlinedIcon/></button>
                            </div>
                        </div>
