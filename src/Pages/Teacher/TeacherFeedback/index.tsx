...
const TeacherFeedback=()=>{
    const Questions = [
        ...
        {
            id: 3,
            question: "Does the teacher encourage questions and discussions in class?",
            options: {
                1: "Yes, always",
                2: "Sometimes",
                3: "Rarely",
        ...
        {
            id: 7,
            question: "Does the teacher use diverse methods to explain topics (e.g., examples, visuals, etc.)?",
            options: {
                1: "Yes, very often",
                2: "Sometimes",
                3: "Rarely",
        ...
        {
            id: 8,
            question: "How approachable is the teacher for doubts and clarifications?",
            options: {
                1: "Very approachable",
                2: "Approachable",
