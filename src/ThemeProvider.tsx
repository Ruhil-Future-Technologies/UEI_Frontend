...
import { ConfigProvider, theme as antdTheme } from 'antd'; // 👈 AntD imports
import 'antd/dist/reset.css'; // Optional: Resets default AntD styles
          ...
          theme={{
            ...
            components: {
              Select: {
                ...
                colorBorder: isDarkMode ? '#555' : '#a8a8a8',
              ...
              Form: {
                labelColor: isDarkMode ? '#ccc' : '#444',
                colorText: isDarkMode ? '#eee' : '#111',
              },
              Tooltip: {
                colorBgSpotlight: isDarkMode ? '#555' : '#f9f9f9',
